...
def assemble(array,n):
	...
	if array[0] in ["FCVT","FCVTW"]:
		mode = {"FCVT":"0","FCVTW":"1"}
		ins = mode[array[0]]+"00000000000"+reg_dic[array[1]]+"000"+reg_dic[array[2]]+"0111000"
	if array[0]=="FSUB":
		ins = "1000000"+reg_dic[array[2]]+reg_dic[array[1]]+"000"+reg_dic[array[3]]+"0110000"
	if array[0]=="FMUL":
		ins = "0000000"+reg_dic[array[2]]+reg_dic[array[1]]+"000"+reg_dic[array[3]]+"0110100"
	if array[0]=="FEQ":
		ins = "0000000"+reg_dic[array[2]]+reg_dic[array[1]]+"000"+reg_dic[array[3]]+"0111100"
...
#输出指令
ass = open('ass.s','r',encoding='utf-8')
o = open('../init_file/insmem.txt','w')
view = open('insmem_view.txt','w',encoding='utf-8')
line = ass.readline()
n=0
while line:
	if line[0] =="." or line[0] =="@" : 
		...
		if array != []:
			...
			ins = assemble(array,n*4)
			view.write(str(n*4) + " : " + line[0:-1] + " : \n" + '\t\t\t\t\t\t' + str(p(ins)) + '\n' )
			# print(line[0:-1],":")
			# print('\t\t\t\t\t\t',p(ins))
			if ins != 0:
				o.write(ins+'\n')
