...
#
# Generated by export_simulation on Wed Jul 22 02:41:26 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './four_body_bram_1.sh' script.

./four_body_bram_1.sh -reset_run
...
./four_body_bram_1.sh -noclean_files

For more information on the script, please type './four_body_bram_1.sh -help'.
