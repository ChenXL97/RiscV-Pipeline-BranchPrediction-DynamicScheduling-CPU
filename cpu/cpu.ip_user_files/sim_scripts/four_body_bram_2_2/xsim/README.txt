...
#
# Generated by export_simulation on Mon Aug 10 22:11:23 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './four_body_bram_2.sh' script.

./four_body_bram_2.sh -reset_run
...
./four_body_bram_2.sh -noclean_files

For more information on the script, please type './four_body_bram_2.sh -help'.
