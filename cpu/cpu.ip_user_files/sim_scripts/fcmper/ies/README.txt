...
#
# Generated by export_simulation on Tue Jul 21 12:16:05 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './fcmper.sh' script.
...
./fcmper.sh -noclean_files

For more information on the script, please type './fcmper.sh -help'.
