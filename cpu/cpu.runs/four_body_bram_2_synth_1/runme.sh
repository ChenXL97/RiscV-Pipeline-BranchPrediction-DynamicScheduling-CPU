...
HD_PWD='C:/Users/Administrator/Desktop/RV-052BG/RiscV-Pipeline-BranchPrediction-DynamicScheduling-CPU/cpu/cpu.runs/four_body_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_body_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_body_bram_2.tcl
